...
public static class ModbusSlaveClientExtensions
{
    ...
    /// 订阅运行状态变化事件
    /// </summary>
    public static IModbusSlaveClient OnRunningChanged(this IModbusSlaveClient slave, Action<bool> handler)
    {
    ...
    /// 订阅保持寄存器写入事件
    /// </summary>
    public static IModbusSlaveClient OnHoldingRegisterWritten(this IModbusSlaveClient slave, Action<ushort, ushort, ushort> handler)
    {
    ...
    /// 订阅线圈写入事件
    /// </summary>
    public static IModbusSlaveClient OnCoilWritten(this IModbusSlaveClient slave, Action<ushort, bool> handler)
    {
    ...
    /// 订阅客户端连接事件
    /// </summary>
    public static IModbusSlaveClient OnClientConnected(this IModbusSlaveClient slave, Action<string> handler)
    {
    ...
    /// 订阅客户端断开事件
    /// </summary>
    public static IModbusSlaveClient OnClientDisconnected(this IModbusSlaveClient slave, Action<string> handler)
    {
